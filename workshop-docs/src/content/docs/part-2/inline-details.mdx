...
:::tip[Good news!]
The CSS already defines styles for flex-columns, called `navigation-panel` & `details-panel`.
:::
...
Open `templates/recipe_list_items.html` and add another attribute to the detail link:
